...
<div class="col-10 grid-margin stretch-card" >
                <div class="card" style="width:60%;"align="center">
                  <div class="card-body" style="width:60%;" align="center">
       				<h4 align="center">考勤${empty param.aab901?'记录':'修改' }</h4>
       	    		  <div class="form-group" align="left">
                        <label for="aab103" >学生编号  :</label>
                        <e:text styleClass="form-control" id="aab103" name="aab103" defval="${ins.aab103}" />
                      </div>
                      <div class="form-group" align="left">
                        <label for="aab902" >考勤日期  :</label>
                        <e:date styleClass="form-control" id="aab902" name="aab902" defval="${ins.aab902}" />
                      </div>
                      <div class="form-group" align="left">
                        <label for="aab903" >考勤状态  :</label>
                        <e:select styleClass="form-control" value="缺勤:1,请假:2" id="aab903" name="aab903" defval="${ins.aab903}" />
                      </div>
                      <div class="form-group" align="left">
                        <label for="aab904" >备注  :</label>
                        <e:textarea  cols="30" rows="6" styleClass="form-control" id="aab904" name="aab904" defval="${ins.aab904}" />
                      </div>
                      <div class="form-group" align="center">
                      <button type="submit" class="btn btn-success mr-2" formaction="<%=path%>/EC0501${empty param.aab901?'Add':'Modify' }Absence.html?aab901=${param.aab901 }">${empty param.aab901?'添加':'修改'}</button>
